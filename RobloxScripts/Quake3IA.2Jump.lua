...
local m_AirSettings: MovementSettings    = { MaxSpeed = 15, Acceleration =  1, Deceleration =  1 }
local m_StrafeSettings: MovementSettings = { MaxSpeed = 20, Acceleration = 12, Deceleration = 30 }
